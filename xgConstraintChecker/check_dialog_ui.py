...
class Ui_check_dialog(object):
    def setupUi(self, check_dialog):
        ...
        self.grp_check.setGeometry(QtCore.QRect(10, 10, 421, 351))
        ...
        self.chk_show_results = QtGui.QCheckBox(self.grp_check)
        self.chk_show_results.setGeometry(QtCore.QRect(200, 220, 141, 17))
        self.chk_show_results.setObjectName(_fromUtf8("chk_show_results"))
        self.grp_report = QtGui.QGroupBox(self.grp_check)
        self.grp_report.setGeometry(QtCore.QRect(10, 240, 401, 101))
        ...
        self.lbl_created_by.setGeometry(QtCore.QRect(10, 70, 71, 16))
        self.lbl_created_by.setObjectName(_fromUtf8("lbl_created_by"))
        self.txt_word_report = QtGui.QPlainTextEdit(self.grp_report)
        self.txt_word_report.setGeometry(QtCore.QRect(100, 20, 261, 42))
        ...
        self.txt_created_by.setGeometry(QtCore.QRect(100, 70, 261, 21))
        ...
        check_dialog.setTabOrder(self.chk_word_report, self.chk_show_results)
        check_dialog.setTabOrder(self.chk_show_results, self.txt_word_report)
    ...
    def retranslateUi(self, check_dialog):
        ...
        self.chk_show_results.setText(_translate("check_dialog", "Show result layers", None))
