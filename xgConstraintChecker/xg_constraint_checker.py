...
from xg_constraint_checker_dialog import xgConstraintCheckerDialog
import os.path
...
class xgConstraintChecker:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'xgConstraintChecker_{}.qm'.format(locale))
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/xgConstraintChecker/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'ESDM Constraint Checker'),
            callback=self.run,
