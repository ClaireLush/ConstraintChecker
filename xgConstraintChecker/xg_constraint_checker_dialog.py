...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'xg_constraint_checker_dialog_base.ui'))


class xgConstraintCheckerDialog(QtGui.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(xgConstraintCheckerDialog, self).__init__(parent)
